...
\subsection{Emergence of a two-channel Kondo Model}
...
\subsection{Marginal Fermi liquid behaviour in the pseudogap}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.24\textwidth]{tiled_I2_k_edge-1.pdf}
