...
\end{aligned}\end{equation}
Beyond the transition and inside the Mott insulating phase, this zero frequency pole continues to exist and marks the hard gap in the spectral function for charge excitations.
