...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.4\textwidth]{pWaveEsiam.pdf}
	\caption{Caption.}
	\label{pWaveEsiam}
\end{figure}
...
\textbf{Arising from the Kondo spin-exchange term}
\begin{equation}\begin{aligned}
...
\end{aligned}\end{equation}
\textbf{Arising from spin-preserving scattering within conduction bath}
\begin{equation}\begin{aligned}
...
\end{aligned}\end{equation}
\textbf{Arising from spin-flip scattering within conduction bath}
\begin{equation}\begin{aligned}
...
\end{aligned}\end{equation}
In all of the terms \(T_{P[i]}\) and \(T_{F[i]}\), the factor of \(1/2\) in front has been cancelled out by a factor of 2 coming from the multiple possibilities of arranging the momentum labels.
...
\paragraph*{Scattering arising purely from spin-preserving processes}
...
\paragraph*{Scattering arising from spin-flip processes}
...
\paragraph*{Scattering involving both spin-flip and spin-preserving processes}
...
\paragraph*{Net renormalisation for the bath correlation term}
...
\paragraph*{Impurity-mediated spin-flip scattering purely through Kondo-like processes}
...
\paragraph*{Scattering processes involving interplay between the Kondo interaction and conduction bath interaction}
...
\paragraph*{Net renormalisation to the Kondo interaction}
Combining the results from eqs.~\ref{kondoRenorm1}, \ref{kondoRenorm2}, \ref{kondoRenorm3} and \ref{kondoRenorm4}, as well as using the properties \(J_{{\bf \bar q}, {\bf k}_1} J_{{\bf k}_2,{\bf \bar q}} = J_{{\bf q}, {\bf k}_2} J_{{\bf k}_1,{\bf q}}\) and \(J_{{\bf q}, {\bf \bar q}} W_{{\bf \bar q}, {\bf k}_2, {\bf k}_1, {\bf q}} = J_{{\bf \bar q}, {\bf q}} W_{{\bf q}, {\bf k}_2, {\bf k}_1, {\bf \bar q}}\), the total renormalisation in the momentum-resolved Kondo coupling \(J^{(j)}\) at the \(j^\text{th}\) step amounts to
\begin{equation}\begin{aligned}
	\Delta J^{(j)}_{{\bf k}_1, {\bf k}_2} = -\sum_{{\bf q} \in \text{PS}} \frac{\frac{1}{2}\left(J^{(j)}_{{\bf k}_2,{\bf q}} J^{(j)}_{{\bf q},{\bf k}_1} + J^{(j)}_{{\bf k}_1,{\bf q}} J^{(j)}_{{\bf q},{\bf k}_2}\right) + 4J^{(j)}_{{\bf q}, {\bf \bar q}} W_{{\bf \bar q}, {\bf k}_2, {\bf k}_1, {\bf q}}}{\omega - \frac{1}{2}|\varepsilon_j| + J^{(j)}_{{\bf q}}/4 + W_{{\bf q}}/2}
\end{aligned}\end{equation}
