...
\begin{equation}\begin{aligned}
	...
	\begin{bmatrix} \Sigma_\text{loc}(\omega) && \Sigma_\text{near-n}(\omega) \\ \Sigma_\text{near-n}(\omega) && \Sigma_\text{loc}(\omega)\end{bmatrix} &= 1/G^{(0)} - \frac{1}{\lambda_{\vec k_0}^2}\frac{1}{\mathcal{G}_{dd}^2 - \mathcal{G}_{dz}^2 / \mathcal{W}^2}\begin{bmatrix} \mathcal{G}_{dd} && -\frac{1}{\mathcal{W}}\mathcal{G}_{dz} \\ -\frac{1}{\mathcal{W}}\mathcal{G}_{dz} && \mathcal{G}_{dd}\end{bmatrix}~.
\end{aligned}\end{equation}
