...
\begin{equation}\begin{aligned}
	...
	G_H (\vec k, \omega) &\simeq G_H (\omega)_\text{loc} + G_H (\omega)_\text{nn}\sum_{i=1}^w e^{i \vec{k}\cdot\vec {a_i}}\\
			     ...
			     &= \frac{2}{N}\sum_n\left[|C^0_{n}|^2 \frac{1}{g_n} - |\overline C^0_{n}|^2 \frac{1}{\overline{g_n}} + \frac{\xi_{\vec{k}}}{w}\left({C^0_{n}}^* C^1_{n} \frac{1}{g_n} - {C^0_{n}}^* \overline C^1_{n} \frac{1}{\overline{g_n}}\right)\right]
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	A_{H}(\vec{k},\omega) &= -\frac{1}{\pi} \textrm{Im}(G_{H}(\vec{k},\omega)) = -\frac{2}{N\pi} \textrm{Im}\sum_n\left[|C^0_{n}|^2 \frac{1}{g_n} - |\overline C^0_{n}|^2 \frac{1}{\overline{g_n}} + \frac{\xi_{\vec{k}}}{w}\left({C^0_{n}}^* C^1_{n} \frac{1}{g_n} - {C^0_{n}}^* \overline C^1_{n} \frac{1}{\overline{g_n}}\right)\right]\\
...
\begin{equation}\begin{aligned}
	\label{Gk_dim}
	G(k=0,\uparrow) = \frac{2}{N}\sum_n\left[|C^0_{n}|^2 \frac{1}{g_n} - |\overline C^0_{n}|^2 \frac{1}{\overline{g_n}} + \frac{\xi_{\vec{k}}}{w}\left({C^0_{n}}^* C^1_{n} \frac{1}{g_n} - {C^0_{n}}^* \overline C^1_{n} \frac{1}{\overline{g_n}}\right)\right]
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\ket{\pm} = \frac{1}{\sqrt 2}\left(\ket{\uparrow, 2} \pm \ket{2, \uparrow}\right), && H^D \ket{\pm} = \pm t\ket{\pm}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	...
	&=x\ket{+} + y\ket{-}
\end{aligned}\end{equation}
where $x + y \equiv a_2$ and $x-y \equiv -a_1$. Similarly, for the other excitation, we can write
\begin{equation}\begin{aligned}
