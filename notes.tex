...
\begin{table}[htpb!]
	...
	$a_1(U, t) \frac{1}{\sqrt 2}\left(\ket{\uparrow,\downarrow} - \ket{\downarrow,\uparrow}\right) \pm a_2(U, t)\frac{1}{\sqrt 2}\left(\ket{2,0} + \ket{0,2}\right)$ & $\ket{\pm}$ & \(\pm \frac{1}{2}\Delta(t, U)\)\\
...
\hline
	...
	\(-a_1\left(\pm U, t\right)\ket{\sigma,0} \pm a_2\left(\pm U, t\right)\ket{0, \sigma}\) & \(\ket{0\sigma_\pm}\) & \(\pm\frac{1}{4}\Delta(U,t)\)\\
	...
	\(a_1\left(\pm \frac{U}{2}, t\right) \frac{1}{\sqrt 2}\left(\ket{\uparrow,\downarrow} - \ket{\downarrow, \uparrow}\right) \pm a_2\left(\pm \frac{U}{2}, t\right) \frac{1}{\sqrt 2}\left(\ket{2,0} + \ket{0, 2}\right)\) & \(\ket{\pm}\) & \(\pm\frac{1}{2}\Delta(\frac{U}{2},t)\)\\
	\(a_1\left(\pm U, t\right)\ket{\sigma,2} \pm a_2\left(\pm U, t\right)\ket{2, \sigma}\) & \(\ket{2\sigma_\pm}\) & \(\pm\frac{1}{4}\Delta(U,t)\)\\
