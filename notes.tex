...
\begin{equation}\begin{aligned}
	...
	E^H_\text{GS} &=  -\frac{1}{2}\Delta\left( U^H, t^H \right),\quad E^A_\text{GS} =  -\frac{1}{2}\Delta\left( \frac{1}{2}U^A, t^A \right), \quad\Delta(x,y) \equiv \sqrt{x^2 + 16y^2}\\
\end{aligned}\end{equation}
...
\section*{Appendix}
\subsection{Spectrum of the Anderson molecule}
Here we tabulate the eigenstates and eigenvalues of the Hamiltonian in eq.~\ref{and_dimer}.
\begin{table}[htpb]
	\centering
	\begin{tabular}{|c|c|c|}
	\hline
