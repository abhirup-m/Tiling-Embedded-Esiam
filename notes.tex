...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.8\textwidth]{dimer_bath.png}
	\caption{The process of symmetrizing the Rg fixed point Hamiltonian and then creating a dimer+bath Hamiltonian.}
	\label{dimer-bath}
\end{figure}
