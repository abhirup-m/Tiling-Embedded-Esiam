...
\begin{equation}\begin{aligned}
	\ket{\Psi^H_\text{GS}} &= a_1(t^H, U^H)\frac{1}{\sqrt 2}\left(\ket{\uparrow_1, \downarrow_2} - \ket{\downarrow_1, \uparrow_2}\right) + a_2(t^H, U^H){\sqrt 2}\left(\ket{\uparrow_1\downarrow_1, } - \ket{,\uparrow_2\downarrow_2}\right)\\
	\ket{\Psi^A_\text{GS}} &= a_1(t^A, \frac{1}{2}U^A)\frac{1}{\sqrt 2}\left(\ket{\uparrow_d, \downarrow_z} - \ket{\downarrow_d, \uparrow_z}\right) + a_2(t^A, \frac{1}{2}U^A){\sqrt 2}\left(\ket{\uparrow_d\downarrow_d, } - \ket{,\uparrow_z\downarrow_z}\right)\\
	E^H_\text{GS} &=  -\frac{1}{2}\Delta\left( U^H, t^H \right), E^A_\text{GS} =  -\frac{1}{2}\Delta\left( \frac{1}{2}U^A, t^A \right)
\end{aligned}\end{equation}
where 
\begin{equation}\begin{aligned}
	a_1(x,y) \equiv \frac{4x}{\sqrt{2\Delta(x,y)\left( \Delta(x,y) - y \right) }}, && a_2(x,y) \equiv \sqrt{\frac{\Delta(x,y) - y}{2\Delta(x,y)}}, &&\Delta(x,y) \equiv \sqrt{x^2 + y^2}\\
\end{aligned}\end{equation}
...
\section*{Appendix}
\subsection*{Particle-Hole symmetric Hubbard dimer spectrum}
Here we document the entire spectrum of the Hamiltonian eq.~\ref{hubb_dimer}.
\begin{table}[htpb]
	\centering
	\begin{tabular}{|c|c|c|}
	\hline
	Wavefunction & Symbol & Eigenvalue \\
	\hline
	$\ket{0,0}$ & $\ket{0}$ & \( \frac{U}{2}\)\\
	$ \frac{1}{\sqrt 2}\left(\ket{\sigma,0} \pm \ket{0,\sigma}\right)$ & $\ket{0\sigma_\pm}$ & \(\mp t\)\\
	$\ket{\sigma,\sigma}$ & $\ket{\sigma\sigma}$ & \( -\frac{U}{2}\)\\
	$ \frac{1}{\sqrt 2}\left(\ket{\uparrow,\downarrow} + \ket{\downarrow,\uparrow}\right)$ & $\ket{ST}$ & \( -\frac{U}{2}\)\\
	$ \frac{1}{\sqrt 2}\left(\ket{2,0} - \ket{0,2}\right)$ & $\ket{CS}$ & \( \frac{U}{2}\)\\
	$a_1(t,U) \frac{1}{\sqrt 2}\left(\ket{\uparrow,\downarrow} - \ket{\downarrow,\uparrow}\right) \pm a_2(t,U)\frac{1}{\sqrt 2}\left(\ket{2,0} + \ket{0,2}\right)$ & $\ket{\pm}$ & \(\pm \frac{1}{2}\Delta(t, U)\)\\
	$ \frac{1}{\sqrt 2}\left(\ket{\sigma,2} \pm \ket{2,\sigma}\right)$ & $\ket{2\sigma_\pm}$ & \(\pm t\)\\
	$\ket{2,2}$ & $\ket{4}$ & \( \frac{U}{2}\)\\
\hline
	\end{tabular}
...
\begin{equation}\begin{aligned}
	G_{i i}^\sigma(\omega, T \to 0) &= \frac{1}{2}\left[\frac{1}{\omega + E_{GS} + t} + \frac{1}{\omega + E_{GS} - t}\right]
\end{aligned}\end{equation}
