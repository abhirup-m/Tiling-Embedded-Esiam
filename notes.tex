...
\end{aligned}\end{equation}
For reasons that will become apparent later, we will scale the internal Hubbard dimer by half, pulling out a two:
\begin{equation}\begin{aligned}
	\label{H_tiled}
...
\begin{equation}\begin{aligned}
	G_H(\vec r = 0, \omega) = \text{Det }G_D\frac{g_0}{g_0^2 - 4g_1^2}
\end{aligned}\end{equation}
