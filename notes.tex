...
\begin{equation}\begin{aligned}
	\label{green_eq}
	\omega - {G_H}^{-1}(\omega) = \frac{1}{Nw}\sum_{i=1}^N\sum_{j\in\text{N.N. of }i}\left(\omega - {G_A}^{-1}(\omega)\right) \left(t^A \to \frac{Nw}{2}t^H, U^A \to N U^H, d \to i, z \to j\right)
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	{G_H}^{-1}(\omega) = \frac{1}{Nw}\sum_{i=1}^N\sum_{j\in\text{N.N. of }i}{G_{i, j}}^{-1}(\omega) 
\end{aligned}\end{equation}
where $G_{i, j}^{-1} = \omega - H^A_{i, j}$, and $H^A_{i, j}$ is defined as
\begin{equation}\begin{aligned}
	H^A_{i, j} = -\frac{Nw}{2}t^H\sum_{\sigma}\left(c^\dagger_{i\sigma}c_{j\sigma} + \text{h.c.}\right) + N U^H\hat \tau_{i \uparrow}\hat \tau_{i \downarrow}
\end{aligned}\end{equation}
