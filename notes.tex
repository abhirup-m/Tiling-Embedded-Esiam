...
\hline
	...
	eigenstate & symbol & eigenvalue\\
	\hline
	\(\ket{0,0}\) & \(\ket{0}\) & \(\frac{U}{4}\)\\
	\(-\frac{4t}{\sqrt{2\Delta(U,t)\left( \Delta(U,t) \pm U\right)}}\ket{\sigma,0} \pm \frac{1}{\sqrt{2\Delta}}\ket{0, \sigma}\) & \(\ket{0\sigma_\pm}\) & \(\pm\frac{1}{4}\Delta(U,t)\)\\
	\(\ket{\sigma,\sigma}\) & \(\ket{\sigma\sigma}\) & \(-\frac{U}{4}\)\\
	\(\frac{1}{\sqrt 2}\left(\ket{\uparrow, \downarrow} + \ket{\downarrow, \uparrow}\right)\) & \(\ket{ST}\) & \(-\frac{U}{4}\)\\
	\(\frac{1}{\sqrt 2}\left(\ket{2, 0} - \ket{0, 2}\right)\) & \(\ket{CS}\) & \(\frac{U}{4}\)\\
	\(-\frac{4t}{\sqrt{2\Delta(\frac{1}{2}U,t)\left( \Delta(\frac{1}{2}U,t) \pm \frac{1}{2}U\right)}}\frac{1}{\sqrt 2}\left(\ket{\uparrow,\downarrow} - \ket{\downarrow, \uparrow}\right) \pm \sqrt{\frac{1}{2} \pm \frac{1}{2}\frac{U/2}{\Delta(\frac{U}{2},t)}}\frac{1}{\sqrt 2}\left(\ket{2,0} + \ket{0, 2}\right)\) & \(\ket{\pm}\) & \(\pm\frac{1}{2}\Delta(\frac{U}{2},t)\)\\
	\(\frac{4t}{\sqrt{2\Delta(U,t)\left( \Delta(U,t) \pm U\right)}}\ket{\sigma,2} \pm \frac{1}{\sqrt{2\Delta}}\ket{2, \sigma}\) & \(\ket{0\sigma_\pm}\) & \(\pm\frac{1}{4}\Delta(U,t)\)\\
	\(\ket{2,2}\) & \(\ket{4}\) & \(\frac{U}{4}\)\\
	\hline
	\end{tabular}
