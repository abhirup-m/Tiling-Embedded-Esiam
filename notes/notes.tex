...
\section{Evolution of the impurity spectral function}

\subsection*{Impurity spectral function}
\begin{center}
	\includegraphics[width=0.45\textwidth]{../figures/spec_func_U_by_J=0.000.pdf}
	\includegraphics[width=0.45\textwidth]{../figures/spec_func_U_by_J=0.115.pdf}\\
	\includegraphics[width=0.45\textwidth]{../figures/spec_func_U_by_J=0.117.pdf}
	\includegraphics[width=0.45\textwidth]{../figures/spec_func_U_by_J=0.250.pdf}\\
	\includegraphics[width=0.45\textwidth]{../figures/spec_func_U_by_J=0.40.pdf}
\end{center}

\subsection*{Width of central peak}
