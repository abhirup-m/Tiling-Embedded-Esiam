...
\subsection{Possibly a more minimal model: \(U,J,U_b\)}
...
\begin{equation}\begin{aligned}
 ...
 - \left.\left(z^h_n\right)^* d^h_n \left(\mathcal{G}_\text{aux}(d, -\omega)\right)_{nn}\right]= G(\omega)_\text{aux,dz}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\label{self-energy1}
	\Sigma_{H-H}(\vec k,\omega) &= \left(G^{(0)}(\vec k,\omega)\right)^{-1} - \left\{\sum_n\left[\left(|d^p_n|^2 + \frac{\xi_{\vec{k}}}{w}\left(d^p_n\right)^* z^p_n\right) \left(\mathcal{G}_\text{aux}(d, \omega)\right)_{nn} - \left(|d^h_n|^2 + \frac{\xi_{\vec{k}}}{w}\left(z^h_n\right)^* d^h_n\right) \left(\mathcal{G}_\text{aux}(d, -\omega)\right)_{nn}\right]\right\}^{-1}\\
&= \left(G^{(0)}(\vec k,\omega)\right)^{-1} - \left [G_\text{aux,dd} + \frac{\xi_{\vec k}}{w} G_\text{aux,dz}\right]^{-1}
\end{aligned}\end{equation}
