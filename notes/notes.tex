...
The method is closely tied to the auxiliary system approach described in [CITE MARTIN]. We can view the full Hamiltonian as a sum of two component Hamiltonians \(H_1, H_2\) connected via the interaction term \(H_{12}\).
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.3\textwidth]{../figures/dimer_bath.png}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=\textwidth]{../figures/siam_specfunc_all.pdf}
...
\end{figure}
\\\\
Because we kept only a discrete bath of 4 momentum states, \textit{we had to artificially enforce the constancy of the height of the central peak, using \cite{langreth1966}.} To convert the discrete sum of delta functions into a continuous spectrum, we broadened them using a Gaussian. Following \cite{bullaNRGreview}, we replace the delta-functions at \(\pm x_n \equiv \pm(E_n - E_0)\) by normalised Gaussian functions
\begin{equation}\begin{aligned}
...
\begin{figure}[htpb!]
	\centering
	\includegraphics[width=0.55\textwidth]{../figures/width_vs_U_simple_fit.pdf}
	% \includegraphics[width=0.49\textwidth]{./width_vs_U_simple_fit_log.pdf}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.3\textwidth]{../figures/dimer-nn.png}
