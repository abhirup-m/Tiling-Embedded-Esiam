...
\begin{figure}[!htpb]
	\centering
	\includegraphics[width=0.6\textwidth]{../figures/spec_func_width_fit.pdf}
\end{figure}
...
\begin{center}
	\includegraphics[width=0.3\textwidth]{../figures/spec_func_U_by_J=0.000.pdf}
	\includegraphics[width=0.3\textwidth]{../figures/spec_func_U_by_J=0.250.pdf}
	\includegraphics[width=0.3\textwidth]{../figures/spec_func_U_by_J=0.40.pdf}
...
\end{aligned}\end{equation}
\textit{This transfer of spectral weight across energy scales of the order of \(U\), as well as the lack of poles at zero energies, is referred to as mottness.}
\begin{figure}[!htpb]
	\centering
