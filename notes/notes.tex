...
\begin{equation}\begin{aligned}
	\ket{\Psi_\text{gs}} = \sum_{\vec a \in \text{NN of}\vec R_0}\frac{1}{\mathcal{Z}\lambda_{\vec k_0}} e^{i\vec{k}_0\cdot\vec{R}_0} \ket{\psi_\text{aux}(\vec R_0, \vec a)} + \ket{\psi_\text{diff}(\vec k_0)}
\end{aligned}\end{equation}
...
Specifically, for the local Greens function, we keep the states with \(\vec R_j = \vec R_0\), leading to the expression
\begin{equation}\begin{aligned}\label{greens_func_approx}
	G_\text{H-H}(\vec r, t) &= -\frac{1}{\lambda_{\vec k_0}^2 \mathcal{Z}^2}i\theta(t) \sum_{\vec a_1, \vec a_2}\braket{\psi_\text{aux}(\vec R_0, \vec a_2) | \left\{ e^{i N \mathcal{H}_\text{aux}(\vec R_0) t}c(\vec R_0 + r)e^{-i N \mathcal{H}_\text{aux}(\vec R_0) t}, c^\dagger(\vec R_0) \right\} | \psi_\text{aux}(\vec R_0, \vec a_1)}~.
\end{aligned}\end{equation}
Because of the symmetry of the lattice, all Greens functions obtained for various positions of the zeroth site \(\vec a_1\) and \(\vec a_2\) are equal to their mean:
\begin{equation}\begin{aligned}
	G_\text{H-H}(\vec r=0, t) &= -\frac{1}{\lambda_{\vec k_0}^2 }i\theta(t) \braket{\psi_\text{aux}(\vec R_0) | \left\{ e^{i N \mathcal{H}_\text{aux}(\vec R_0) t}c(\vec R_0 + r)e^{-i N \mathcal{H}_\text{aux}(\vec R_0) t}, c^\dagger(\vec R_0) \right\} | \psi_\text{aux}(\vec R_0)}~.
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	...
	G_\text{H-H}(\vec r=0, t) &= \frac{1}{\lambda_{\vec k_0}^2}\mathcal{G}_{dd}(t)~.
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	G_\text{H-H}(\vec r, t) &= -\frac{1}{\lambda_{\vec k_0}^2 \mathcal{Z}^2}i\theta(t) \sum_{\vec a_1}\braket{\psi_\text{aux}(\vec R_0, \vec a_1) | \left\{ e^{i N \mathcal{H}_\text{aux}(\vec R_0) t}c(\vec R_0 + r)e^{-i N \mathcal{H}_\text{aux}(\vec R_0) t}, c^\dagger(\vec R_0) \right\} | \psi_\text{aux}(\vec R_0, \vec a_1)}~.
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	G_\text{H-H}(\vec r, t) &= -\frac{1}{\lambda_{\vec k_0}^2 \mathcal{Z}}i\theta(t) \braket{\psi_\text{aux}(\vec R_0, \vec a) | \left\{ e^{i N \mathcal{H}_\text{aux}(\vec R_0) t}c(\vec R_0 + r)e^{-i N \mathcal{H}_\text{aux}(\vec R_0) t}, c^\dagger(\vec R_0) \right\} | \psi_\text{aux}(\vec R_0, \vec a)} = \frac{1}{\lambda_{\vec k_0}^2 \mathcal{Z}} \mathcal{G}_{dz}(t)~.
\end{aligned}\end{equation}
...
\end{aligned}\end{equation}
The first summation produces a factor of $N$, while the second summation can be factorized into a sum over all sites (which again returns $N$) and a sum over all the primitive vectors connecting any single site with all its nearest neighbours, $\left\{ \vec a_i: i \in \left[1, \mathcal{Z}\right]\right\}$.
\begin{equation}\begin{aligned}
	\label{k_Gf_siam}
	G_{H-H} (\vec k, \omega) &\simeq G_{H-H} (\omega)_\text{loc} + G_{H-H} (\omega)_\text{n-n}\sum_{i=1}^{\mathcal{Z}} e^{i \vec{k}\cdot\vec {a_i}} = \frac{1}{\lambda_{\vec k_0}^2}\left[\mathcal{G}_{dd}(\omega) + \frac{1}{\mathcal{Z}}\mathcal{G}_{dz}(\omega) \xi_{\vec k}\right]~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	...
	A_\text{H-H}(\vec{k},\omega) = \frac{1}{\lambda_{\vec k_0}^2}\left[\mathcal{A}_{dd} + \xi_{\vec k} \frac{1}{\mathcal{Z}^2}\mathcal{A}_{dz} \right]~,
\end{aligned}\end{equation}
