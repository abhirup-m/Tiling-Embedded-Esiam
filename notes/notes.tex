...
\begin{equation}\begin{aligned}
	t^H = \frac{1}{N}\left(2t (N-2) - \frac{2V}{N}\right),~ ~ U^H = \frac{1}{N}\left(\frac{U}{2} + U_b\right), ~ ~ J_H = \frac{2J}{Nw}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	...
	\left(G_{H-H}(\omega)\right)_\text{nn} &= \left(G_{H-H}(\omega)\right)_{i,i+1}^p - \left(G_{H-H}(-\omega)\right)_{i+1,i}^h = \frac{1}{Nw}\sum_n \left[\left(d^p_n\right)^* z^p_n \left(\mathcal{G}_\text{aux}(d, \omega) \right)_{nn} - \left(z^h_n\right)^* d^h_n \left(\mathcal{G}_\text{aux}(d, -\omega)\right)_{nn}\right] 
\end{aligned}\end{equation}
