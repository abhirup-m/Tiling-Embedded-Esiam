...
\chapter{From the auxiliary model to the bulk}
...
\begin{equation}\begin{aligned}
	\label{siam_to_hubb}
	\frac{1}{Nw}\sum_i \sum_{j \in \text{NN of i}} \mathcal{H}_\text{aux}(i,j) = \mathcal{H}_{H-H}
\end{aligned}\end{equation}

\section{Single-particle Green's function}
We now define the Greens function {\it operators}:
\begin{equation}\begin{aligned}
	\mathcal{G}_H = \frac{1}{\omega - H_{H-H}}, \mathcal{G}_\text{aux}(i,j) = \frac{1}{\omega - H_\text{aux}(i,j)}
\end{aligned}\end{equation}
Rewriting eq.~\ref{siam_to_hubb} in terms of these operators, we get
\begin{equation}\begin{aligned}
	\frac{1}{Nw}\sum_i \sum_{j \in \text{NN of i}} \left(\omega - \mathcal{G}^{-1}_\text{aux}(i,j)\right) = \omega - \mathcal{G}^{-1}_{H-H} \implies \frac{1}{Nw}\sum_i \sum_{j \in \text{NN of i}} \mathcal{G}^{-1}_\text{aux}(i,j) = \mathcal{G}^{-1}_{H-H}
\end{aligned}\end{equation}
There we used \(\frac{1}{Nw}\sum_i \sum_{j \in \text{NN of i}} \omega = \omega\). 
