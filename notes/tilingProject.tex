...
\begin{equation}\begin{aligned}
	\rho_{\vec k,\sigma} =& \sum_{n_{(d,z,1),\sigma}=0,1}\frac{1}{2\lambda_{\vec k_0}^2 \mathcal{W}}\left[\bar\psi^\dagger_{n_{d\sigma}}\bar\psi_{n_{d\sigma}} + \frac{1}{\mathcal{W}}\bar\psi^\dagger_{n_{z\sigma}}\bar\psi_{n_{z\sigma}}\right]\\
