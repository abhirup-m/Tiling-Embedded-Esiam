...
\makeatletter
\apptocmd{\thebibliography}{\global\c@NAT@ctr 89\relax}{}{}
\makeatother
\begin{document}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.4\linewidth]{Ad_zoomout_77-1500.pdf}
...
\bibitem{santanukagome}
Santanu Pal, Anirban Mukherjee, and Siddhartha Lal.
\newblock Correlated spin liquids in the quantum kagome antiferromagnet at
  finite field: a renormalization group analysis.
\newblock {\em New Journal of Physics}, 21(2):023019, feb 2019.

\bibitem{1dhubjhep1}
Anirban Mukherjee, Siddhartha Patra, and Siddhartha Lal.
\newblock Fermionic criticality is shaped by fermi surface topology: a case
  study of the tomonaga-luttinger liquid.
\newblock {\em Journal of High Energy Physics}, 2021(4):148, Apr 2021.

\bibitem{anirbanmott1}
Anirban Mukherjee and Siddhartha Lal.
\newblock Scaling theory for mott{\textendash}hubbard transitions: I. t = 0
  phase diagram of the 1/2-filled hubbard model.
\newblock {\em New Journal of Physics}, 22(6):063007, jun 2020.

\bibitem{siddharthacpi}
Siddhartha Patra and Siddhartha Lal.
\newblock Origin of topological order in a cooper-pair insulator.
\newblock {\em Phys. Rev. B}, 104:144514, Oct 2021.

\bibitem{anirban_kondo}
Anirban Mukherjee, Abhirup Mukherjee, N.~S. Vidhyadhiraja, A.~Taraphder, and
  Siddhartha Lal.
\newblock Unveiling the kondo cloud: Unitary renormalization-group study of the
  kondo model.
\newblock {\em Phys. Rev. B}, 105:085119, Feb 2022.

\bibitem{Patra_2023}
Siddhartha Patra, Anirban Mukherjee, and Siddhartha Lal.
\newblock Universal entanglement signatures of quantum liquids as a guide to
  fermionic criticality.
\newblock {\em New Journal of Physics}, 25(6):063002, jun 2023.

\bibitem{Herr1987}
S.~L. Herr, K.~Kamar\'as, C.~D. Porter, M.~G. Doss, D.~B. Tanner, D.~A. Bonn,
  J.~E. Greedan, C.~V. Stager, and T.~Timusk.
\newblock Optical properties of
  ${\mathrm{la}}_{1.85}$${\mathrm{sr}}_{0.15}$${\mathrm{cuo}}_{4}$: Evidence
  for strong electron-phonon and electron-electron interactions.
\newblock {\em Phys. Rev. B}, 36:733--735, Jul 1987.

\bibitem{Orenstein1987}
Joseph Orenstein, G.~A. Thomas, D.~H. Rapkine, C.~G. Bethea, B.~F. Levine,
  R.~J. Cava, E.~A. Rietman, and D.~W. Johnson.
\newblock Normal-state gap transition in cu-o superconductors.
\newblock {\em Phys. Rev. B}, 36:729--732, Jul 1987.

\bibitem{Uchida1991}
S.~Uchida, T.~Ido, H.~Takagi, T.~Arima, Y.~Tokura, and S.~Tajima.
\newblock Optical spectra of
  ${\mathrm{la}}_{2\mathrm{\ensuremath{-}}\mathit{x}}$${\mathrm{sr}}_{\mathit{x}}$${\mathrm{cuo}}_{4}$:
  Effect of carrier doping on the electronic structure of the
  ${\mathrm{cuo}}_{2}$ plane.
\newblock {\em Phys. Rev. B}, 43:7942--7954, Apr 1991.

\bibitem{Thomas1992Optical}
G.~A. Thomas, D.~H. Rapkine, S.~L. Cooper, S-W. Cheong, A.~S. Cooper, L.~F.
  Schneemeyer, and J.~V. Waszczak.
\newblock Optical excitations of a few charges in cuprates.
\newblock {\em Phys. Rev. B}, 45:2474--2479, Feb 1992.

\bibitem{Dagotto1994RMP}
Elbio Dagotto.
\newblock Correlated electrons in high-temperature superconductors.
\newblock {\em Rev. Mod. Phys.}, 66:763--840, Jul 1994.

\bibitem{nozieres1974fermi}
P~Nozieres.
\newblock A ``fermi-liquid" description of the kondo problem at low
  temperatures.
\newblock {\em Journal of Low Temperature Physics}, 17:31, 1974.
